# Graph Report - JW-REMINDERS  (2026-07-28)

## Corpus Check
- 313 files · ~1,078,726 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2676 nodes · 3951 edges · 184 communities (146 shown, 38 thin omitted)
...
## Communities (184 total, 38 thin omitted)

### Community 0 - "monthly-schedules.service.ts"
Cohesion: 0.06
Nodes (72): call(), cleanup(), main(), ok(), sleep(), startFakeWhatsApp(), waReceived, cancelAssignment() (+64 more)
...
Cohesion: 0.09
Nodes (22): Batch, MensajesPage(), Msg, renderWhatsapp(), Schedule, TYPES, PlantillasPage(), renderWhatsapp() (+14 more)
...
## Knowledge Gaps
- **1224 isolated node(s):** `check-api.sh script`, `check-deploy.sh script`, `deployA.lf.sh script`, `deployA.sh script`, `deployA2.lf.sh script` (+1219 more)
...
- **Why does `d()` connect `process-reminders.ts` to `operational-center.service.ts`, `index.ts`, `page.tsx`, `index.ts`, `api`, `WeekAutomations.tsx`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `api()` connect `api` to `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `index.ts`, `AssignmentReminders.tsx`, `AssignmentForm.tsx`, `page.tsx`, `page.tsx`, `WeekGenerationModal.tsx`, `page.tsx`, `WeekAutomations.tsx`?**
...
- **Should `app.js` be split into smaller, more focused modules?**
  _Cohesion score 0.0951048951048951 - nodes in this community are weakly interconnected._