# Graph Report - JW-REMINDERS  (2026-07-29)

## Corpus Check
- 313 files · ~1,079,671 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2681 nodes · 3967 edges · 188 communities (150 shown, 38 thin omitted)
...
5. `Lead` - 25 edges
6. `createAutomationPlanForAssignment()` - 19 edges
7. `resolveWolReference()` - 19 edges
8. `runProcessReminders()` - 19 edges
9. `apiGet()` - 18 edges
...
Cohesion: 0.07
Nodes (61): cleanup(), log(), main(), received, startFakeWhatsApp(), deliveryInclude, isOpenNotSent(), mapDelivery() (+53 more)
...
Cohesion: 0.08
Nodes (51): f(), main(), autoPauseSends(), BATCH_SIZE, claimGroup(), delay(), deliveryToMessagePart(), envInt() (+43 more)
...
Cohesion: 0.15
Nodes (19): Assignment, AssignmentForm(), emptyForm, nextNumber(), Props, Publisher, ROOMS, SECTION_ORDER (+11 more)
...
Cohesion: 0.12
Nodes (20): AssistantCard(), PHRASES, STEP_MAP, useResearchChat(), ResearchChatClient(), ChatMessage, GeneratedComment, LoadingStep (+12 more)
...
### Community 25 - "api"
Cohesion: 0.15
Nodes (19): WAStatus, WhatsAppPage(), createSession(), deleteSession(), fetchProfiles(), fetchSession(), fetchSessions(), generateMoreVariants() (+11 more)
...
Cohesion: 0.16
Nodes (15): EmptyState(), HighlightedText(), CloseIcon(), PlusIcon(), SearchIcon(), SidebarIcon(), TrashIcon(), LoadingIndicator() (+7 more)
...
Cohesion: 0.12
Nodes (16): PlantillasPage(), renderWhatsapp(), Template, TYPE_LABEL, VariableDef, Version, completion(), emptyForm (+8 more)
...
Cohesion: 0.15
Nodes (9): Config, MessageLog, statusConfig, MonthlySchedule, MONTHS, ProgramasPage(), statusClass(), statusLabel() (+1 more)
...
Cohesion: 0.18
Nodes (11): 24.1 Pruebas locales obligatorias, 24.3 Regla de correccion, 24.4 Reporte final, 24.5 Criterio final, 24. FLUJO OBLIGATORIO DE PRUEBAS Y CORRECCION, Build, Contenido obligatorio del reporte, Funcionales (+3 more)
...
Cohesion: 0.29
Nodes (7): 24.2 Pruebas en produccion obligatorias, Auth, Funcionales, Infraestructura, Seguridad, WhatsApp, Worker

### Community 187 - "page.tsx"
Cohesion: 0.40
Nodes (5): EnviarPage(), Publisher, renderWhatsapp(), SendState, Template

## Knowledge Gaps
- **1225 isolated node(s):** `check-api.sh script`, `check-deploy.sh script`, `deployA.lf.sh script`, `deployA.sh script`, `deployA2.lf.sh script` (+1220 more)
...
- **Why does `d()` connect `process-reminders.ts` to `operational-center.service.ts`, `index.ts`, `index.ts`, `page.tsx`, `page.tsx`, `WeekAutomations.tsx`?**
  _High betweenness centrality (0.057) - this node is a cross-community bridge._
- **Why does `api()` connect `api` to `page.tsx`, `WeekGenerationModal.tsx`, `page.tsx`, `AssignmentReminders.tsx`, `index.ts`, `page.tsx`, `AssignmentForm.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `WeekAutomations.tsx`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `listMonthlySchedules()` connect `monthly-schedules.service.ts` to `page.tsx`?**
