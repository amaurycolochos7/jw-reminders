...
## Corpus Check
- 322 files · ~1,092,064 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2764 nodes · 4087 edges · 190 communities (152 shown, 38 thin omitted)
...
Cohesion: 0.07
Nodes (62): cleanup(), log(), main(), received, startFakeWhatsApp(), deliveryInclude, isOpenNotSent(), mapDelivery() (+54 more)
...
Cohesion: 0.09
Nodes (36): Anchor, decodeEntities(), ensureCbsReaderPart(), ensureStandardMeetingParts(), ENTITIES, extractAnchors(), finalizeImport(), findVidaYMinisterioLink() (+28 more)
...
Cohesion: 0.10
Nodes (32): AssignmentRow(), Assignment, AssignmentForm(), emptyForm, nextNumber(), Props, Publisher, ROOMS (+24 more)
...
Cohesion: 0.07
Nodes (39): AssistantCard(), EmptyState(), HighlightedText(), CloseIcon(), PlusIcon(), SearchIcon(), SidebarIcon(), TrashIcon() (+31 more)
...
### Community 25 - "api"
Cohesion: 0.10
Nodes (23): Config, EnviarPage(), Publisher, renderWhatsapp(), SendState, Template, MessageLog, statusConfig (+15 more)
...
Cohesion: 0.22
Nodes (5): assertSecurityConfig(), rateLimit(), apiRouter, allowedOrigins, app
...
Cohesion: 0.13
Nodes (20): WeekPart, Assignment, formatDate(), groupAssignmentsBySection(), MeetingWeek, monthName(), ProgramItem, Publisher (+12 more)

### Community 35 - "workflow-icons.tsx"
Cohesion: 0.07
Nodes (37): DashboardLayout(), Alert, DashboardPage(), MONTHS_LONG, OperationalCenter, parseLocalDate(), QuickAction(), relativeSync() (+29 more)
...
Cohesion: 0.09
Nodes (22): AutomatizacionesPage(), fmtTimer(), OpsStatus, SendGroup, TYPE_LABELS, WorkerPhase, Badge(), BadgeProps (+14 more)
...
Cohesion: 0.19
Nodes (6): listResearchProfiles(), createPromptRule(), listPromptRules(), featureGuard(), isResearchChatEnabled(), router
...
Cohesion: 0.27
Nodes (8): getJwtSecret(), authMiddleware(), AuthRequest, loginSchema, router, isBcrypt(), login(), sha256()
...
Cohesion: 0.12
Nodes (14): router, router, router, createSchema, router, updateSchema, router, ACTIVE (+6 more)
...
## Knowledge Gaps
- **1248 isolated node(s):** `check-api.sh script`, `check-deploy.sh script`, `deployA.lf.sh script`, `deployA.sh script`, `deployA2.lf.sh script` (+1243 more)
...
- **Why does `api()` connect `api` to `page.tsx`, `workflow-icons.tsx`, `page.tsx`, `AssignmentReminders.tsx`, `index.ts`, `AssignmentForm.tsx`, `page.tsx`, `page.tsx`, `page.tsx`, `WeekGenerationModal.tsx`, `page.tsx`, `page.tsx`, `WeekAutomations.tsx`?**
